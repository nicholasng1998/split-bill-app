...
class P2PSetupModel {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'userId': userId,
      'status': status,
      'lendAmount': lendAmount.toString(), // Convert BigDecimal to String (if you are using BigDecimal in Flutter)
      'remainingAmount': remainingAmount.toString(), // Convert BigDecimal to String (if you are using BigDecimal in Flutter)
