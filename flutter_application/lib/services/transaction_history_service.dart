...
/**
 * Transaction History Create Function
 */
Future<CommonResponseModel?> create(BuildContext context,
    String transactionType, double transactionAmount, int groupId) async {
  final String url = TRANSACTION_HISTORY_CREATE;
